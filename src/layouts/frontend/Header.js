        ...
        <div>
            <nav className="py-1" style={{ backgroundColor: `#E48586` }}>
                <div className="container d-flex flex-wrap">
                    ...
                    <ul className="nav">
                        <li className="nav-item"><a href="#" className="nav-link link-body-emphasis px-2 text-white">Thông báo</a></li>
                        <li className="nav-item"><a href="#" className="nav-link link-body-emphasis px-2 text-white">Đăng nhập</a></li>
                        <li className="nav-item"><a href="#" className="nav-link link-body-emphasis px-2 text-white">Đăng ký</a></li>
                    </ul>
                </div>
            </nav>
